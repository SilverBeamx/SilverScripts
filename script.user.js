...
(function() {
    ...
    function activateDisco() {
        var disco = new Audio("https://cdn.discordapp.com/attachments/966675880896245780/1190401147794620447/ouch.mp3");
        disco.play();
    }
    ...
    function addQuickSwitcherButton(){
        ...
        subContainer.id = "silverScriptsQuickSwitcherUsersDisplay";
        ...
        button.addEventListener("click",function(){
            document.getElementById("silverScriptsQuickSwitcherUsersDisplay").style.display = "none";
